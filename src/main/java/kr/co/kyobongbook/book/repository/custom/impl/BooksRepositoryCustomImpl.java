...
//    public Page<Book> findBooksByParams(FindBooksRequest request) {
//        Pageable pageable = request.toPageable();
//        List<Book> list = jpaQueryFactory.selectFrom(books)
...
//        if (CATEGORY_ID.equals(sortName) || CATEGORY_NAME.equals(sortName)) {
